...
type Props = { characterId: string; name: string; className?: string; avatarUrl?: string | null }
...
export function CharacterArtwork({ characterId, name, className = '', avatarUrl }: Props) {
  const portrait = avatarUrl || portraits[characterId]
